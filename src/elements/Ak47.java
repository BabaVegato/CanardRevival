...
public class Ak47 extends Objet{
	...
	public void action() {
		...
		shot.play();
		if (Droite) screen.projectiles.add(new Bullet(jeu, monde, screen, can, 5, 5, body.getPosition().x + 15, body.getPosition().y));
		else screen.projectiles.add(new Bullet(jeu, monde, screen, can, 5, 5, body.getPosition().x - 15, body.getPosition().y));
